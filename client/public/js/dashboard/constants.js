export const classes = {
  ...
  field:
    'w-full bg-transparent border border-zinc-300 dark:border-zinc-700 rounded-sm px-3 py-2 text-sm font-mono font-normal text-zinc-900 dark:text-zinc-100 placeholder:text-zinc-400 dark:placeholder:text-zinc-600 focus:outline-none focus:ring-1 focus:ring-zinc-900 dark:focus:ring-zinc-100 transition-colors duration-100',
  button:
    'bg-transparent border border-zinc-300 dark:border-zinc-700 text-zinc-900 dark:text-zinc-100 font-mono font-normal text-sm rounded-sm px-4 py-2 hover:bg-zinc-900 hover:text-zinc-100 hover:border-zinc-900 dark:hover:bg-zinc-100 dark:hover:text-zinc-900 dark:hover:border-zinc-100 active:scale-[0.97] transition-all duration-100',
  actionButton:
    'bg-transparent border border-zinc-300 dark:border-zinc-700 text-zinc-900 dark:text-zinc-100 font-mono font-normal text-sm rounded-sm px-3 py-1.5 hover:bg-zinc-900 hover:text-zinc-100 hover:border-zinc-900 dark:hover:bg-zinc-100 dark:hover:text-zinc-900 dark:hover:border-zinc-100 active:scale-[0.97] transition-all duration-100',
  card: 'bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-sm p-4',
  tableWrap: 'overflow-auto bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-sm',
  tableHead:
...
export const navClass = {
  base: 'block rounded-sm border border-zinc-300 dark:border-zinc-700 px-3 py-2 text-sm font-mono font-normal text-zinc-900 dark:text-zinc-100 transition-colors duration-100',
  active: 'bg-zinc-900 text-zinc-100 border-zinc-900 dark:bg-zinc-100 dark:text-zinc-900 dark:border-zinc-100',
